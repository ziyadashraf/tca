...
const posts = [
  {
    ...
    title: "TCA Branding",
    description:
      "Explore the latest trends and best practices in web development, from responsive design to performance optimization.",
    images: [
  ...
  },
  {
    ...
    description:
      "Learn how to design scalable and resilient cloud solutions for modern applications.",
    images: [
      "https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=2072&q=80",
      "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
    ],
  ...
  },
  {
    ...
    description:
      "Discover how to leverage AI capabilities to enhance your software solutions.",
    images: [
      "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
    ],
    thumbnailImage:
...
export default function ServicesPage() {
  ...
  const selectedPost = selectedProject
    ? posts.find((post) => post.id === selectedProject)
    : null;
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg leading-8 text-gray-600">
            Stay updated with the latest technological advances and expert
            insights.
          </p>
        </div>
