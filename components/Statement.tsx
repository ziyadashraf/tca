...
const Statement = () => {
    ...
    return (
        <div className={`bg-black lg:px-64 lg:py-24 md:py-16 md:px-12 py-12 px-6 ${lang === "ar" ? "text-right" : "text-left"}`}>
            <h6 className={`text-justify text-white font-normal lg:text-2xl mb-4 text-justify text-lg ${lang === "ar" ? "text-right" : "text-left"}`}>
                {lang === "ar" ?
            ...
            <p className={`text-justify text-white lg:text-lg text-justify text-md ${lang === "ar" ? "text-right" : "text-left"}`}>
                {lang === "ar" ?
