...
const Statement = () => {
    return (
        <div className="bg-gradient-to-b from-transparent to-black min-h-[200px]">
            <h6 className='text-justify'>At TCA, we&apos;re all about changing how businesses see design and creativity,
