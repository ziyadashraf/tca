...
const Statement = () => {
    return (
        <div className="bg-black lg:px-64 lg:py-24 md:py-16 md:px-12 py-12 px-6 ">
            <h6 className='text-justify text-white font-normal lg:text-2xl mb-4 text-justify text-lg'>At TCA, we&apos;re all about changing how businesses see design and creativity,
