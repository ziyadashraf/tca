  ...
  return (
    <div className="bg-black  pt-16 ">
      ...
      <div className="lg:px-40  px-6">
        <Timeline data={about?.journey?.steps} />
      </div>
    </div>
  );
};
...
const data = [
  {
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          This year marked the beginning of an exciting journey. I focused on
          exploring different design systems, improving my development workflow,
          and experimenting with various frameworks.
        </p>
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          This year, I refined my design skills, took on new challenges, and
          worked on making interfaces more user-friendly. I started using Figma
          extensively for prototyping and experimented with animations.
        </p>
        <img
          src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80"
          alt="Design Work"
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          Animation and interactivity took center stage this year. I started
          integrating Framer Motion into projects, creating delightful
          micro-interactions and enhancing user experiences.
        </p>
        <div className="grid grid-cols-2 gap-4">
          <img
            src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80"
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          This year, I went deeper into full-stack development, using Next.js
          for server-side rendering, API routes, and performance optimizations.
          I also worked on integrating databases and authentication.
        </p>
        <div className="grid grid-cols-2 gap-4">
          <img
            src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80"
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          ...
          integrate lorem ipsum. Lorem ipsum is for people who are too lazy to
          write copy. But we are not. Here are some more example of beautiful
          designs I built.
        </p>
