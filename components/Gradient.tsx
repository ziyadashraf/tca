...
const Gradient = async () => {
  ...
  return (
    <div
      className=" h-40 p-64 pt-40 pb-40 flex flex-col justify-center items-start"
      style={{
    ...
    >
      <h6 className="text-black text-xl font-light mb-8 uppercase">
        {services?.title || "Our Services"}
      </h6>

      <p className="text-black text-3xl font-medium w-1/2">
