...
const Gradient = () => {
    return (
        <div className=" h-40 p-64 pt-32 pb-32 flex flex-col justify-center items-start" style={{
            ...
            <h6 className='text-black text-2xl font-medium mb-8'>Our Services</h6>

            <p className='text-black text-3xl'>We Offer a Wide Range of Creative Solutions
