...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div className="w-full bg-neutral-950 font-sans md:px-10 pb-40" ref={containerRef}>
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                ...
                <div
                    ...
                    className="absolute md:left-8 left-8 rtl:right-8 rtl:left-auto top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-700 to-transparent to-[99%] 
